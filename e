...
-- ====== TELEPORT LIST ======
local teleportList = {
	{name = "Teleport Pos 1", pos = Vector3.new(316.76, 283.931, -371.114), delay = 0.5},
	{name = "Teleport Pos 2", pos = Vector3.new(-114.648, 181.941, -437.199), delay = 0.5},
	{name = "Teleport Pos 3", pos = Vector3.new(-28.8, 283.037, -278.612), delay = 0.5},
	{name = "Teleport Pos 4", pos = Vector3.new(-149.516, 291, -39.611), delay = 0.5},
	{name = "Teleport Pos 5", pos = Vector3.new(129.476, 242.513, 2.379), delay = 0.5},
	{name = "Teleport Pos 6", pos = Vector3.new(-196.583, 259.229, 330.856), delay = 0.5},
	{name = "Teleport Pos 7", pos = Vector3.new(-236.291, 328.294, 95.276), delay = 0.5},
	{name = "Teleport Pos 8", pos = Vector3.new(-390.676, 346.687, 313.931), delay = 0.5},
	{name = "Teleport Pos 9", pos = Vector3.new(-330.837, 436.996, 538.634), delay = 0.5},
	{name = "Teleport Pos 10", pos = Vector3.new(-370.591, 659.408, 463.58), delay = 0.5},
	{name = "Teleport Pos 11", pos = Vector3.new(-994.134, 604.705, 235.787), delay = 0.5},
	{name = "Teleport Pos 12", pos = Vector3.new(-1235.155, 558.207, -139.037), delay = 0.5},
	{name = "Teleport Pos 13", pos = Vector3.new(-1072.917, 661.81, -392.899), delay = 0.5},
	{name = "Teleport Pos 14", pos = Vector3.new(-1415.557, 696.399, -493.615), delay = 0.5},
	{name = "Teleport Pos 15", pos = Vector3.new(-1739.669, 770.04, -264.98), delay = 0.5},
	{name = "Teleport Pos 16", pos = Vector3.new(-1896.357, 885.737, 43.199), delay = 0.5},
	{name = "Teleport Pos 17", pos = Vector3.new(-1693.067, 886.227, 301.779), delay = 0.5},
	{name = "Teleport Pos 18", pos = Vector3.new(-1814.4, 1097.6, 948.977), delay = 0.5},
	{name = "PUNCAK", pos = Vector3.new(-3747.774, 1463.488, 1077.128), delay = 1},
